...
export interface HeadProps {
  ...
  /** Открыть подробности: там же стоит и форма плана. */
  onSetPlan: () => void
  /**
      ...
      <span class="f-head2__sub">
        {limit !== null ? (
          ...
          /* Коротко: длинная фраза занимала третью строку, и шапка от неё
               ...
               «Подробнее», а не «задать план»: кнопка открывает всё хозяйство
               сразу — графики, разбор, копилку с планом, — и обещать одну
               только форму плана значит обещать меньше, чем даёшь. */
          <>
            не с чем сравнить —{' '}
